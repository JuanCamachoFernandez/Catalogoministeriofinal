...
La caché pública usa una versión compartida en PostgreSQL, por lo que varios procesos WSGI observan invalidaciones sin Redis. `PUBLIC_CACHE_TTL_SECONDS` permite cambiar el valor predeterminado de 60 segundos.
