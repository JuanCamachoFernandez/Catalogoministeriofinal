...
export type Product={id:string;exhibitor_id:string;nombre:string;descripcion:string;precio:number|null;estado:'AVAILABLE'|'OUT_OF_STOCK';imagenes:{url:string;is_cover:boolean}[]};
