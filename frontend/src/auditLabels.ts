...
export function auditDescriptionLabel(value?: string | null) {
  ...
  description = description
    ...
    .replace(/\bcontrasena\b/gi, "contraseña")
...
export const positiveAuditActions = new Set([
  "CREAR",
  "RESTAURAR",
  "AGREGAR_IMAGEN",
  "AUTORIZAR",
...
export const warningAuditActions = new Set([
  "EDITAR",
  "CAMBIAR_ESTADO",
  "SINCRONIZAR_ESTADO",
  "EDITAR_IMAGEN",
...
export const negativeAuditActions = new Set([
  "ELIMINAR",
  "ELIMINAR_IMAGEN",
  "REVOCAR",
  "BLOQUEAR",
