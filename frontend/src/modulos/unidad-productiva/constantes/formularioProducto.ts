...
export const camposProducto: Array<{
  ...
  },
  {
    ...
    placeholder: "Ej.: Algodón, miel, maíz, etc.",
    required: true,
    maxLength: 2000,
  },
  {
    ...
    placeholder: "Ej.: Caja 12 unidades, Bolsa pequeña, Frasco de vidrio, etc.",
    required: true,
    maxLength: 255,
  },
  {
  ...
  },
  {
    ...
    hint: "Indique la cantidad disponible o capacidad de producción aproximada en unidades al mes.",
    placeholder: "Ej.: 100, 15, etc.",
    required: true,
    type: "number",
    inputMode: "numeric",
    min: "0",
  ...
  },
  {
    ...
    hint: "Escriba los colores en los que ofrece el producto, separados por espacios.",
