...
import { assetUrl, type CanonicalProduct } from "../api";
import { Empty, Modal, StatusBadge } from "../ui";

export function ProductiveUnitProductDetailPage({
  product,
  onBack,
}: {
  ...
  const currentImageUrl = currentImage ? assetUrl(currentImage.url_imagen) : "";
          ...
          <div className="admin-unit-detail-identity">
            {currentImage ? (
              <img
                ...
                src={assetUrl(currentImage.url_imagen)}
