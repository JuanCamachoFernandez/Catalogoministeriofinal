...
from ..esquemas import error, user_json, validate_json, validated_json
...
from ..repositorios.usuarios import buscar_usuario_para_login
from ..servicios.autenticacion import contrasena_segura, puede_recuperar_contrasena
...
def login():
    ...
    user = buscar_usuario_para_login(value)
